<template>
    <div>
        <el-row>
            ...
            <el-row>
                <el-table :data="nowEditData" 
                    ...
                    <el-table-column align="center" prop="ft_name" label="故障类型" width=""></el-table-column>
        ...
        <!-- 添加、编辑模板 -->
        <el-dialog :title="dialogTitle" :visible.sync="dialogHandleTypeVisible" width="40%" append-to-body>
            <HandleType :editData="editDataHandleType"  @editClose="editCloseHandleType" @updateData="$emit('updateData')"></HandleType>
        </el-dialog>
    </div>
</template>

<script>
    import { getDeviceFaultTypeDelete } from '../../../../../api/deviceManage.js'
    import HandleType from './handleType.vue'
    export default {
        components: {
            HandleType,
        },
        ...
        methods: {
            ...
            handleEditTemplate(index, row) {
                ...
                this.editDataHandleType = {
                    editData: row
                };
                this.dialogHandleTypeVisible = true;
            },
            // 删除
            ...
            editCloseHandleType() {
                this.dialogTitle = '';
                this.dialogHandleTypeVisible = false;
