<template>
    <div>
        <el-form ref="faultTypeEdit" :rules="rules" label-width="80px" :model="nowEditData">
            ...
            <el-form-item>
                <el-button type="primary" @click="submitForm('faultTypeEdit', nowEditData.add)">{{ btnMsg }}</el-button>
...
<script>
    import { getDeviceFaultTypeAdd, getDeviceFaultTypeEdit } from '../../../../../api/deviceManage.js'
    export default {
        props: {
            editData: {
                type: Object
        ...
        watch: {
            editData: {
                ...
                handler(newValue, oldValue) {
                    ...
                    setTimeout( () => {
                        this.$refs.faultTypeEdit.clearValidate();
                    }, 0)
