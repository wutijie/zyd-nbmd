<template>
    <div class="deviceManage-deviceFault h100p">
        <el-row class="h100p">
            ...
            <el-row class="mould-fault-tab-wrap">
                <el-table id="out-device-fault" :data="tableData" style="width: 100%;" height="100%" border :cell-class-name="tableRowClassName">
...
<script>
    import { getDeviceFaultRecord, getDeviceRepairFaultRecordStartEnd } from '../../../../api/deviceManage.js'
    ...
    export default {
        ...
        methods: {
            ...
            handleRepairTime(index, row, type) {
                ...
                this.$confirm('是否要' + showMsg + '该设备故障?', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning',
                    center: true
                }).then(() => {
                    getDeviceRepairFaultRecordStartEnd({
                        type,
                        did: row.d_id,
                        id: row.fr_id
                    }).then(res => {
            ...
            // 导出
            handleExport() {
                this.$exportExcel('#out-device-fault','设备管理-设备故障');
            },
            // 搜索
            handleSearch(){
