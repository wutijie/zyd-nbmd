        ...
        <div id="templateWrap">
            <div class="box" v-for="(item, index) in tableData" :key="index">
                <div v-for="(item2, index2) in item" :key="index2" class="item">
                    ...
                    <el-select :disabled="isAdd == 3" v-else-if="item2.type == 'select'" v-model="item2.value" placeholder="">
                        <el-option
...
<script>
    import { getDeviceRepairRecordEditContent } from '../../../../../api/deviceManage.js'
    export default {
        props: {
            editData: {
                type: Object
        ...
        methods: {
            handleSubmit() {
                ...
                getDeviceRepairRecordEditContent({
