<template>
    <div class="mould-handle-template-wrap">
        <el-form ref="mouldHandleTem" :model="nowEditData" :rules="rules" label-width="80px">
            <el-row :gutter="10">
                <el-col :span="12">
            ...
            <el-form-item class="sub-handle">
                <el-button type="primary" @click="handleSubmit('mouldHandleTem', isAdd)">{{ btnMsg }}</el-button>
...
<script>
    import { getMouldMaintainTemplateAdd, getMouldMaintainTemplateEdit } from '../../../../../api/mouldManage.js'
    export default {
        props: {
            editData: {
                type: Object
        ...
        watch: {
            editData: {
                ...
                handler(newValue, oldValue) {
                    setTimeout( () => {
                        this.$refs.mouldHandleTem.clearValidate();
                    }, 0)
                    ...
                    if(newValue.nowRow){
                        ...
                        // this.nowEditData.mt_genre = this.nowRow.mt_genre == "二级保养" ? 4 : 3;
                        this.$set(this.nowEditData, 'mt_genre', this.nowEditData.mt_genre == "二级保养" ? 4 : 3);
                    }
                    if(this.isAdd && this.isAdd == 1){
                        this.btnMsg = '添加';
                    }else{
