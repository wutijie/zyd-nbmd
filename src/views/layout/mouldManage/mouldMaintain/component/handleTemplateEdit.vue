<template>
    <div class="mould-handle-template-wrap">
        ...
        <el-row class="sub-handle">
            ...
            <el-button type="danger" v-print="'#templateWrap'">打印</el-button>
...
<script>
    import { getMouldMaintainRecordEditContent } from '../../../../../api/mouldManage.js'
    export default {
        props: {
            editData: {
                type: Object
        ...
        methods: {
            handleSubmit() {
                ...
                getMouldMaintainRecordEditContent({
