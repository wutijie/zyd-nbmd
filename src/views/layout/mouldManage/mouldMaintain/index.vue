<template>
    <div class="mouldManage-mouldMaintain h100p">
        <el-row class="h100p">
            <el-row class="handle-btn" :gutter="10">
                ...
                <!-- <el-col :span="3">
                    <el-select v-model="maintainType" size="small" @change="handletype" class="w100p">
                        ...
                        <el-option label="二级保养" :value="2"></el-option>
                ...
                <el-col :span="4">
                    ...
                    <el-select v-else-if="searchData.searchtype == 'mr_genre'" v-model="searchData.searchvalue" size="small" placeholder="工单状态" class="w100p">
                        <el-option label="全部" value=""></el-option>
                        <el-option label="周期保养" value="3"></el-option>
                        <el-option label="二级保养" value="4"></el-option>
                    </el-select>
            ...
            <el-row class="mould-maintain-tab-wrap">
                <!-- 保养列表 -->
                <el-table id="out-mould-maintain" v-show="maintainType == 1" :data="tableData" style="width: 100%;" height="100%" border :cell-class-name="tableRowClassName">
                    ...
                    <el-table-column align="center" label="保养计划号" width="220" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <el-button size="mini" v-if="scope.row.mr_genre == '二级保养'" class="w100p" type="" @click="handleEdit(scope.$index, scope.row, 2)">{{ scope.row.mr_planno }}</el-button>
                    ...
                    <el-table-column align="center" prop="mr_beginTime" label="保养开始时间" width="200" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <el-button v-if="scope.row.mr_beginTime == '' || scope.row.mr_beginTime == null" @click="handleRepairTime(scope.$index, scope.row, 1)" size="mini" type="warning">开始</el-button>
                    ...
                    <el-table-column align="center" prop="mr_endTime" label="保养结束时间" width="200" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <el-button v-if="scope.row.mr_endTime == '' || scope.row.mr_endTime == null" @click="handleRepairTime(scope.$index, scope.row, 2)" size="mini" type="warning">结束</el-button>
                ...
                <!-- 二级保养 -->
                <el-table v-show="maintainType == 2" :data="tableDataSecond" style="width: 100%;" height="100%" border :cell-class-name="tableRowClassName">
...
<script>
    import { getMouldMaintainRecord, getMouldMaintainRecordStartEnd, getMouldCycleMaintain, getMouldSecondMaintain } from '../../../../api/mouldManage.js'
    ...
    export default {
        ...
        methods: {
                ...
                getMouldMaintainRecord({
                    ...
                    if(res.code == 200){
                        ...
                        this.selectData = {
                            ...
                            secondTemplateSelect: res.data.SecondTemplateSelect,
            ...
            handleRepairTime(index, row, type) {
                ...
                this.$confirm('是否要' + showMsg + '该模具保养?', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning',
                    center: true
                }).then(() => {
                    getMouldMaintainRecordStartEnd({
                        type,
                        genre: row.mr_genre == '二级保养' ? 2 : 3,
                        mid: row.m_id,
                        id: row.mr_id
                    }).then(res => {
                        // console.log(res);
            ...
            // 导出
            handleExport() {
                this.$exportExcel('#out-mould-maintain','模具管理-模具保养');
            },
            // 搜索
            handleSearch(){
...
<style lang="scss" scoped>
    .mouldManage-mouldMaintain {
        padding-left: 0.3rem;
        .mould-maintain-tab-wrap {
