        ...
        <el-row>
            ...
            <el-row>
                <el-table :data="nowEditData" 
                    ...
                    <el-table-column align="center" prop="rt_name" label="模板名称" width=""></el-table-column>
...
<script>
    import { getMouldRepairTemplateDelete } from '../../../../../api/mouldManage.js'
        ...
        methods: {
            ...
            handleEditTemplate(index, row) {
                ...
                this.editDataHandleTemplate = {
                    templateData: JSON.parse(row.rt_content),
                    nowRow: row
                };
