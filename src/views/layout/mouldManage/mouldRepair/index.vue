<template>
    <div class="mouldManage-mouldRepair h100p">
        <el-row class="h100p">
            ...
            <el-row class="mould-repair-tab-wrap">
                <el-table id="out-mould-repair" :data="tableData" style="width: 100%;" height="100%" border :cell-class-name="tableRowClassName">
...
<script>
    import { getMouldRepairRecord, getMouldRepairRecordStartEnd } from '../../../../api/mouldManage.js'
    ...
    export default {
        ...
        methods: {
            ...
            handleRepairTime(index, row, type) {
                ...
                this.$confirm('是否要' + showMsg + '该模具维修?', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning',
                    center: true
                }).then(() => {
                    getMouldRepairRecordStartEnd({
                        type,
                        mid: row.m_id,
                        id: row.rr_id
                    }).then(res => {
            ...
            // 导出
            handleExport() {
                this.$exportExcel('#out-mould-repair','模具管理-模具维修');
            },
            // 搜索
            handleSearch(){
